...
class AdvantageEstimator(str, Enum):
    ...
    GAE = "gae"
    GRPO = "grpo"
    GRPO_TREE_DYNAMIC_ADVANTAGE = "grpo_tree_dynamic_advantage"
...
def compute_grpo_tree_dynamic_advantage(
    ...
    positive_scaling_factor: float = 1.5,
    negative_scaling_factor: float = 0.5,
    ...
    Args:
        ...
        step_reward: `(torch.Tensor)`  # 修改了类型注解
        ...
        positive_scaling_factor: `(float)`
            scaling factor when step_reward and token_rewards have same positive sign
        negative_scaling_factor: `(float)`
            scaling factor when step_reward and token_rewards have same negative sign
