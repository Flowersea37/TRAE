...
if TYPE_CHECKING:
    ...
    from trae_verl.experimental.reward_loop.reward_manager.base import RewardManagerBase
...
def load_reward_manager(
    ...
    if reward_manager_cfg.source == "register":
        from trae_verl.workers.reward_manager import get_reward_manager_cls
